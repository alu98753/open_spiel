...
# Lint as python3
"""4x4 Tic-Tac-Toe game implemented in Python for OpenSpiel."""
...
_GAME_TYPE = pyspiel.GameType(
    short_name="python_4x4_tic_tac_toe",
    long_name="Python 4x4 Tic-Tac-Toe",
...
class TicTacToe4Game(pyspiel.Game):
    """A Python version of the 4x4 Tic-Tac-Toe game."""
...
class TicTacToe4State(pyspiel.State):
    """A python version of the 4x4 Tic-Tac-Toe state."""
    ...
    def _apply_action(self, action):
        ...
        self.board[row, col] = "x" if self._cur_player == 0 else "o"
...
def _line_exists(board):
    ...
    for col in board.T:
        if _line_value(col):
            return True
    if _line_value(board.diagonal()) or _line_value(np.fliplr(board).diagonal()):
        return True
    return False
...
pyspiel.register_game(_GAME_TYPE, TicTacToe4Game)