...
# flags.DEFINE_string("params_path", "open_spiel/python/examples/mytest0902",
...
#   # 修改這裡
#   bots = [
#       uniform_random.UniformRandomBot(game, 0),
#       uniform_random.UniformRandomBot(game, 2),
#   ]
#   results = []
...
def load_model():
  net = hk.without_apply_rng(hk.transform(net_fn))
  params = pickle.load(
      open(os.path.join(FLAGS.params_path, "/mnt/zi/Master_Thesis/src/open_spiel/open_spiel/python/examples/mytest0902/params-snapshot.pkl"), "rb"))
  return net, params
